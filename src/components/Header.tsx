...
export default function Header() {
    return <div data-tauri-drag-region class="px-6 pt-6 select-none cursor-default relative z-10">
        <a href="#" onClick={async () => { await exit(1); alert("hi"); }} class="close-btn absolute bg-red-400 right-4 top-4 rounded-full w-3 h-3 hover:bg-red-200 focus:bg-red-200 transition-colors"></a>
        <a target="_blank"
            tabindex="-1"
